...
<div class="header-seccion d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
    <div>
        ...
        <p class="mb-0">Administra las distintas direcciones y áreas municipales.</p>
    </div>
    ...
    <div class="d-flex flex-column flex-sm-row gap-3 align-items-center">
        <div class="input-group shadow-sm rounded">
            ...
            <input type="search" id="buscar-secciones" class="form-control border-0" placeholder="Buscar sección..." style="min-width: 250px;" autocomplete="new-password" data-lpignore="true" readonly onfocus="this.removeAttribute('readonly');">
        </div>

        <button type="button" class="btn btn-light shadow-sm fs-6 px-4 fw-bold text-nowrap" style="height: 38px;" onclick="abrirModalNuevaSeccion()">
            <i class="bi bi-plus-circle me-2"></i> Nueva Sección
        </button>
    </div>
</div>

<div class="row g-4 mt-2" id="contenedor-secciones"></div>
